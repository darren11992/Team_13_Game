...
def battle(n, room):
    ...
    print("")
    print("You're in the heat of the battle! You have " + str(int(current_room["n"]) * a + int(calculate_reputation(inventory))) + " seconds to show your talent and rap " + "'" + players_rap + "'")
